                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input id="toastedTheme1" type="radio" v-model="toastedTheme" value="toasted-primary" class="form-check-input">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="notifText1" type="text" v-model="notifTitle" class="form-control mb-2">
                            <label for="notifText"><strong>Message</strong></label>
                            <input id="notifText2" type="text" v-model="notifMessage" class="form-control mb-2">
                        </div>
                        <p><strong>Position</strong></p>
                        <div class="form-group">
                            <div class="form-check form-check-inline">
